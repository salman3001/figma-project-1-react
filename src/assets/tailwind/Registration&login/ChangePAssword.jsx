  ...
  return (
    <main className="grid relative container mx-auto lg:grid-cols-2 min-h-screen  ">
      ...
      <div className="backdrop-brightness-50 p-10 flex  justify-center items-center fixed container  h-screen w-full peer-checked:hidden visible ">
        <div className="grow max-w-2xl relative rounded-md min-h-1/2 bg-white flex flex-col items-center justify-center p-16 gap-6">
          <label
            htmlFor="modal-check"
          ...
          <form className="flex flex-col gap-4  w-96">
            <Label titile="New Password" for="newPassword" />
            <FormInput
              name="newPassword"
              placeholder="Type new password"
              type="password"
            />
            <Label titile="Confirm New Password" for="confirmNewPassword" />
            <FormInput
