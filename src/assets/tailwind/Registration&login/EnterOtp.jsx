      ...
      <div className="backdrop-brightness-50 p-10 flex  justify-center items-center fixed container  h-screen w-full peer-checked:hidden visible ">
        <div className="grow max-w-2xl relative rounded-md h-1/2 bg-white flex flex-col items-center justify-center p-16 gap-6">
          ...
          <p className="opacity-70 max-w-md text-center">
            We are sending you an OTP to verify
          </p>
          <form className="flex flex-col gap-4  w-96">
            <div className="flex gap-2">
              <FormInput name="otp1" placeholder="" type="number" />
              <FormInput name="otp2" placeholder="" type="number" />
              <FormInput name="otp3" placeholder="" type="number" />
              <FormInput name="otp4" placeholder="" type="number" />
              <FormInput name="otp5" placeholder="" type="number" />
              <FormInput name="otp6" placeholder="" type="number" />
            </div>
            <button
